...
export default function CaptureStatusChip({ status }: { status: ReadinessStatus }) {
  ...
  if (status === "submitted") return <span className="inline-flex items-center gap-1 rounded-md px-2 py-0.5 text-[11px] font-medium bg-warn/10 text-warn-700"><Clock size={10} />Submitted</span>;
