...
export const ACTION_CENTRE = [
  ...
  { label: "Adjusted performance worsening", count: 3,  severity: "bad"  as const, href: "/portfolio/compare" },
];
...
export const PORTFOLIO_HOTELS = [
  { id:"h1",  name:"Skyline Dubai",               shortName:"Skyline Dubai",    region:"EMEA",   type:"Resort",     rooms:420, orn:105000, gn:151200, arn:150000, utility_cost_usd:2664000, carbon_t:9100,  energy_mwh:17200, water_m3:120000, waste_t:1800, diversion_pct:52, waste_kg_per_cover:74, carbonIntensity:86.7, energyIntensity:163.8, waterIntensity:794, dataConfidence:94, status:"active",     renewablePct:8,  yoyCarbon:-3.2, yoyEnergy:-4.8 },
  { id:"h2",  name:"Airport Hotel Dubai",         shortName:"Airport Dubai",    region:"EMEA",   type:"Airport",    rooms:380, orn:86000,  gn:107500, arn:138700, utility_cost_usd:2256000, carbon_t:7200,  energy_mwh:14800, water_m3:90000,  waste_t:1500, diversion_pct:24, waste_kg_per_cover:118,carbonIntensity:83.7, energyIntensity:172.1, waterIntensity:837, dataConfidence:45, status:"active",     renewablePct:0,  yoyCarbon:-1.4, yoyEnergy:-2.3 },
  { id:"h3",  name:"Bay View Singapore",          shortName:"Bay View SG",      region:"APAC",   type:"City Hotel", rooms:350, orn:96000,  gn:134400, arn:126300, utility_cost_usd:1898000, carbon_t:6200,  energy_mwh:12400, water_m3:85000,  waste_t:1200, diversion_pct:48, waste_kg_per_cover:82, carbonIntensity:64.6, energyIntensity:129.2, waterIntensity:633, dataConfidence:82, status:"active",     renewablePct:14, yoyCarbon:-6.1, yoyEnergy:-7.2 },
  { id:"h4",  name:"The Pavilion London",         shortName:"Pavilion London",  region:"EMEA",   type:"City Hotel", rooms:312, orn:88000,  gn:123200, arn:112800, utility_cost_usd:1690000, carbon_t:5700,  energy_mwh:11200, water_m3:72000,  waste_t:1010, diversion_pct:54, waste_kg_per_cover:68, carbonIntensity:64.8, energyIntensity:127.3, waterIntensity:584, dataConfidence:91, status:"active",     renewablePct:28, yoyCarbon:-5.1, yoyEnergy:-6.8 },
  { id:"h5",  name:"Grand Harbour Lisbon",        shortName:"Grand Lisbon",     region:"EMEA",   type:"City Hotel", rooms:280, orn:88000,  gn:123200, arn:110000, utility_cost_usd:1388000, carbon_t:4600,  energy_mwh:8900,  water_m3:70000,  waste_t:900,  diversion_pct:45, waste_kg_per_cover:88, carbonIntensity:52.3, energyIntensity:101.1, waterIntensity:568, dataConfidence:87, status:"active",     renewablePct:18, yoyCarbon:-4.2, yoyEnergy:-4.9 },
  { id:"h6",  name:"Marina Residences Barcelona", shortName:"Marina Barcelona", region:"EMEA",   type:"Resort",     rooms:260, orn:80000,  gn:112000, arn:108100, utility_cost_usd:1236000, carbon_t:4100,  energy_mwh:7800,  water_m3:65000,  waste_t:850,  diversion_pct:28, waste_kg_per_cover:102,carbonIntensity:51.3, energyIntensity:97.5,  waterIntensity:580, dataConfidence:74, status:"active",     renewablePct:4,  yoyCarbon:-2.2, yoyEnergy:-3.1 },
  { id:"h7",  name:"Oceanfront Cape Town",        shortName:"Cape Town",        region:"Africa", type:"Resort",     rooms:210, orn:72000,  gn:100800, arn:88900, utility_cost_usd:888000, carbon_t:2900,  energy_mwh:5900,  water_m3:28000,  waste_t:620,  diversion_pct:55, waste_kg_per_cover:61, carbonIntensity:40.3, energyIntensity:81.9,  waterIntensity:278, dataConfidence:88, status:"active",     renewablePct:42, yoyCarbon:-7.4, yoyEnergy:-9.1 },
  { id:"h8",  name:"The Montrose Paris",          shortName:"Montrose Paris",   region:"EMEA",   type:"Boutique",   rooms:165, orn:64000,  gn:89600,  arn:76200, utility_cost_usd:548000, carbon_t:1850,  energy_mwh:3700,  water_m3:14000,  waste_t:380,  diversion_pct:62, waste_kg_per_cover:55, carbonIntensity:28.9, energyIntensity:57.8,  waterIntensity:156, dataConfidence:96, status:"active",     renewablePct:36, yoyCarbon:-8.2, yoyEnergy:-10.3 },
  { id:"h9",  name:"Peaks Resort Zermatt",        shortName:"Zermatt",          region:"EMEA",   type:"Ski Resort", rooms:95,  orn:16000,  gn:22400,  arn:20000, utility_cost_usd:222000, carbon_t:850,   energy_mwh:1600,  water_m3:5000,   waste_t:100,  diversion_pct:18, waste_kg_per_cover:91, carbonIntensity:53.1, energyIntensity:100.0, waterIntensity:223, dataConfidence:41, status:"seasonal",   renewablePct:24, yoyCarbon:-1.8, yoyEnergy:-2.0 },
  { id:"h10", name:"Riverside Bangkok",           shortName:"Bangkok",          region:"APAC",   type:"City Hotel", rooms:180, orn:20000,  gn:28000,  arn:36400, utility_cost_usd:102000, carbon_t:350,   energy_mwh:700,   water_m3:3000,   waste_t:60,   diversion_pct:38, waste_kg_per_cover:70, carbonIntensity:17.5, energyIntensity:35.0,  waterIntensity:107, dataConfidence:12, status:"onboarding", renewablePct:0,  yoyCarbon:-12.0, yoyEnergy:5.2 },
];
