    ...
    fields: [
      {
        ...
        required: true,
        options: [
          { value: "R-410A", label: "R-410A (GWP 2,256)" },
          { value: "R-134a", label: "R-134a (GWP 1,526)" },
          { value: "R-32",   label: "R-32 (GWP 771)" },
          { value: "R-407C", label: "R-407C (GWP 1,906)" },
          { value: "R-404A", label: "R-404A (GWP 4,728)" },
          { value: "R-22",   label: "R-22 (GWP 1,960)" },
          { value: "R-744",  label: "R-744 / CO₂ (GWP 1)" },
        ],
        hint: "GWP from the factor library (IPCC AR6, 100-year). Emissions = charged − recovered × GWP.",
      },
