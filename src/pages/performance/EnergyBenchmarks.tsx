    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="card p-6 flex flex-col gap-1">
          ...
          <div className="text-kpi font-bold text-brand-700 leading-none tabular-nums">{SAVING_MWH.toLocaleString()} MWh</div>
        ...
        <div className="card p-6 flex flex-col gap-1">
          ...
          <div className="text-kpi font-bold text-good leading-none tabular-nums">${SAVING_USD.toLocaleString()}</div>
